...
async function startServer() {
    var _a;
    // 1️⃣ MongoDB connect
    await mongoose.connect((_a = process.env.FindX_MONGODB_URL) !== null && _a !== void 0 ? _a : "");
    ...
    io.on("connection", (socket) => {
        ...
        socket.on("send_notification", (notification) => {
            io.emit("notification", Object.assign(Object.assign({}, notification), { senderId: studentId || organizerId, timestamp: new Date().toISOString() }));
        });
        // --- Video call events ---
        ...
        socket.on("disconnect", () => {
            console.log(`❌ User disconnected: student=${studentId}, organizer=${organizerId}`);
        });
    });
    // 6️⃣ Start server

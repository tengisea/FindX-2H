...
import { TaskType, AnswerFormat } from "@/types/generated";
export const createChallenge = async (_, { input }) => {
    try {
        ...
        if (input.answerFormatDistribution) {
            ...
            const mapChallengeFormatToAnswerFormat = (format) => {
                switch (format) {
            ...
            const mapToAnswerFormatDistribution = (dist) => ({

...
export const getAllOrganizers = async () => {
    ...
    return hosts.map(host => (Object.assign(Object.assign({}, host.toObject()), { id: host._id.toString(), Olympiads: host.Olympiads.map((olympiad) => ({
            id: olympiad._id.toString(),
            name: olympiad.name,
            description: olympiad.description || "",
            date: olympiad.date || "",
            location: olympiad.location || "",
            organizer: olympiad.organizer && typeof olympiad.organizer === 'object' && 'toObject' in olympiad.organizer ? Object.assign(Object.assign({}, olympiad.organizer.toObject()), { id: olympiad.organizer._id.toString() }) : null,
            classtypes: olympiad.classtypes ? olympiad.classtypes.map((classType) => ({
                id: classType._id.toString(),
                classYear: mapClassYearToGraphQL(classType.classYear),
                maxScore: classType.maxScore,
                questions: classType.questions ? classType.questions.map((question) => ({

import { TaskClassType as GraphQLClassType } from "@/types/generated";
// Simple grade-appropriate templates for allowed topics only
export const gradeAppropriateTemplates = {
...
export const getGradeAppropriateTemplate = (topic, difficulty, classType) => {
    var _a, _b;
    ...
    const templates = (_a = gradeAppropriateTemplates[gradeRange]) === null || _a === void 0 ? void 0 : _a[topic];
    if (!templates || !templates[difficulty]) {
        // Fallback to easy templates for the grade range and topic
        const fallbackTemplates = (templates === null || templates === void 0 ? void 0 : templates.EASY) || ((_b = gradeAppropriateTemplates['GRADE_1_3']['math']) === null || _b === void 0 ? void 0 : _b.EASY);
...
const getGradeNumber = (classType) => {
    switch (classType) {

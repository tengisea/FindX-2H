...
const AdminTournamentBracketPage = () => {
  ...
  const [createPiWard, { loading: piWardLoading, error: piWardError }] =
    useCreatePiWardMutation();
    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <Card>
            <CardContent className="p-12 text-center">
              ...
              <p className="text-gray-600 mb-6">
                Matches haven't been created for this tournament yet. Create
                matches to see the tournament bracket.
              </p>
      ...
      {selectedMatch && (
        <UpdateWinnerModal
          ...
          playerAName={getPlayerName(
            selectedMatch.slotA,
            (selectedMatch as any).slotAData
          )}
          playerBName={getPlayerName(
            selectedMatch.slotB,
            (selectedMatch as any).slotBData
          )}
        />
      )}
    </div>

...
import { useGetTournamentQuery, useGetMatchRoomsQuery, useGetAllStudentsQuery } from '@/generated'
            ...
            <div className="min-h-screen bg-gray-50 flex items-center justify-center">
                <Card className="w-full max-w-md">
                    <CardContent className="p-6 text-center">
                        ...
                        <h3 className="text-lg font-semibold text-gray-900 mb-2">Join Tournament</h3>
                        <p className="text-gray-600 mb-4">
                            You are not registered for this tournament yet. Join to participate and view the bracket.
                        </p>
                    ...
                    <Card>
                        <CardContent className="p-12 text-center">
                            ...
                            <p className="text-gray-600 mb-6">
                                ...
                                Please wait for the tournament to begin.
                            </p>

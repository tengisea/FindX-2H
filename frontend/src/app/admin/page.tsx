...
import { useGetPendingOlympiadsQuery, useGetApprovedOlympiadsQuery, useGetAllOlympiadsQuery, useApproveOlympiadMutation, useGetAllOrganizersQuery, type GetAllOlympiadsQuery } from '@/generated';
...
const AdminPage = () => {
  ...
  const [selectedOlympiad, setSelectedOlympiad] = useState<GetAllOlympiadsQuery['allOlympiads'][0] | null>(null);
  const [isModalOpen, setIsModalOpen] = useState(false);

  const { data: pendingData, loading: pendingLoading, refetch: refetchPending } = useGetPendingOlympiadsQuery();
  ...
  const handleOlympiadClick = (olympiad: GetAllOlympiadsQuery['allOlympiads'][0]) => {
        ...
        return (
          <div className="flex justify-center items-center py-20">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-12 text-center">
              ...
              <div className="text-gray-600 font-medium">Loading pending olympiads...</div>
            </div>
          </div>
        );
      }
      if (!pendingData?.getPendingOlympiads?.length) {
        return (
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-white/20 p-16 text-center">
            ...
            <p className="text-gray-600 text-lg mb-6">No pending olympiads to review at the moment.</p>
            <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl p-6 border border-amber-200 max-w-md mx-auto">
              <p className="text-amber-700 font-medium">Great job! All olympiad requests have been processed.</p>
            </div>
          </div>
        );
      }
        ...
        return (
          <div className="flex justify-center items-center py-20">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-12 text-center">
              ...
              <div className="text-gray-600 font-medium">Loading approved olympiads...</div>
            </div>
          </div>
        );
      }
      if (!approvedData?.getAllApprovedOlympiads?.length) {
        return (
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-white/20 p-16 text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-4">No Approved Olympiads Yet</h3>
            <p className="text-gray-600 text-lg mb-6">Start by reviewing and approving pending olympiad requests.</p>
            <div className="bg-gradient-to-r from-emerald-50 to-green-50 rounded-2xl p-6 border border-emerald-200 max-w-md mx-auto">
              <p className="text-emerald-700 font-medium">Approved olympiads will appear here once they&apos;re reviewed.</p>
            </div>
          </div>
        );
      }
      ...
      if (allLoading) {
        return (
          <div className="flex justify-center items-center py-20">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-12 text-center">
              <div className="animate-spin w-12 h-12 border-4 border-blue-200 border-t-blue-600 rounded-full mx-auto mb-4"></div>
              <div className="text-gray-600 font-medium">Loading all olympiads...</div>
            </div>
          </div>
        );
      }
      if (!allData?.allOlympiads?.length) {
        return (
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-white/20 p-16 text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-4">No Olympiads Found</h3>
            <p className="text-gray-600 text-lg mb-6">The system is ready for your first olympiad event.</p>
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-200 max-w-md mx-auto">
              <p className="text-blue-700 font-medium">Organizers can start creating olympiad requests to get started.</p>
            </div>
          </div>
        );
      }
        ...
        return (
          <div className="flex justify-center items-center py-20">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-12 text-center">
              ...
              <div className="text-gray-600 font-medium">Loading organizers...</div>
            </div>
          </div>
        );
      }
      ...
      if (organizers.length === 0) {
        return (
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-white/20 p-16 text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-4">No Organizers Found</h3>
            <p className="text-gray-600 text-lg mb-6">No organizers have been registered in the system yet.</p>
            <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl p-6 border border-purple-200 max-w-md mx-auto">
              <p className="text-purple-700 font-medium">Organizers need to register before they can create olympiads.</p>
            </div>
          </div>
        );
      }
          ...
          <div className="mb-8">
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-3xl font-bold text-gray-900">All Organizers</h2>
                  <p className="text-gray-600 mt-2">Manage organizer accounts and view their olympiad activities</p>
                </div>
                <div className="text-right">
                  <div className="text-3xl font-bold text-blue-600">{organizers.length}</div>
                  ...
                  <div className="flex items-center space-x-4 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-lg">
                        {activeTab === 'pending' && 'Review and approve olympiad requests'}
                        {activeTab === 'approved' && 'View all approved olympiad events'}
                        {activeTab === 'all' && 'Overview of all olympiad events'}
                        {activeTab === 'organizers' && 'Manage organizer accounts and permissions'}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl p-6 border border-amber-200">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <div className="text-2xl font-bold text-amber-700">{pendingData?.getPendingOlympiads?.length || 0}</div>
                    ...
                    <div className="bg-gradient-to-r from-emerald-50 to-green-50 rounded-2xl p-6 border border-emerald-200">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <div className="text-2xl font-bold text-emerald-700">{approvedData?.getAllApprovedOlympiads?.length || 0}</div>
                          <div className="text-sm text-emerald-600">Approved Events</div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-200">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <div className="text-2xl font-bold text-blue-700">{organizersData?.getAllOrganizers?.length || 0}</div>

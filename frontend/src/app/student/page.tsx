...
//                   Error loading student data: {studentError.message}
//                 </p>
//               </div>
//             ) : student ? (
...
//                       {olympiads.length} Olympiad
//                       {olympiads.length !== 1 ? "s" : ""} Available
//                     </h3>
...
//                         {student.participatedOlympiads.map(
//                           (olympiadId: string) => (
...
//                         Olympiad Notifications
//                       </h4>
//                       <p className="text-sm text-gray-600">
//                         Get notified about new olympiads
//                       </p>
//                     </div>
...
//         studentId={studentId}
//       />
//       <div className="ml-80">{renderContent()}</div>
...
//                     <p className="text-gray-600">
//                       {formatDate(selectedOlympiad.date)}
//                     </p>
//                   </div>
//                   <div>
//                     <h4 className="font-semibold text-gray-900 mb-2">
...
//                     </h4>
//                     <p className="text-gray-600">
//                       {selectedOlympiad.organizer?.organizationName ||
//                         "Unknown"}
//                     </p>
//                   </div>
//                   <div>
...
//                   Choose the grade level you want to register for:
//                 </p>
//               </div>
...
//                   <p className="text-gray-500">
//                     No available grades for your level.
//                   </p>
//                 </div>
//               )}

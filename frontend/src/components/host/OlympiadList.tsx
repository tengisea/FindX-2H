    ...
    if (!olympiads || olympiads.length === 0) {
        return (
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-8 text-center">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-2">No Olympiads Yet</h3>
                <p className="text-gray-600">You haven't created any olympiad requests yet.</p>
            </div>
        );
    }
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                    <label className="flex items-center space-x-2">
                        ...
                        <span className="text-sm text-gray-600">Select all {olympiads.length} olympiads</span>
                    </label>
                </div>
                            ...
                            <div className="flex-1">
                                <div className="flex items-start justify-between mb-4">
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div>
                                            <h3 className="text-lg font-semibold text-gray-900">{olympiad.name}</h3>
                                            <p className="text-sm text-gray-600">Olympiad Competition</p>
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center space-x-4">
                                        <div className="flex items-center space-x-2">
                                            ...
                                            <select className="text-sm border-none bg-transparent text-red-600 font-medium">
                                    ...
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div className="flex space-x-2">
                                            <button
                                                ...
                                                disabled={isDeleting}
                                                className="px-4 py-2 bg-white border border-gray-200 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                            >

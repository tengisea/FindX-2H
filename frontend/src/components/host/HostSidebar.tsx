...
export const HostSidebar = ({
  ...
  const { data: organizerData, loading: organizerLoading } =
    ...
    <div className="fixed left-0 top-0 h-full w-80 bg-white shadow-xl border-r border-gray-200 z-10 hidden lg:block">
      <div className="p-6 lg:p-8">
        ...
        <div className="mb-8">
          ...
          {/* Organizer Info */}
          {organizerLoading ? (
            <div className="bg-gray-50/80 backdrop-blur-sm rounded-xl p-4 mb-4 border border-gray-200">
            ...
            <div className="bg-gradient-to-r from-blue-50/80 to-purple-50/80 backdrop-blur-sm rounded-xl p-4 mb-4 border border-blue-200/50 shadow-sm">
          ...
          {/* Stats */}
          <div className="bg-gradient-to-r from-blue-50/80 to-purple-50/80 backdrop-blur-sm rounded-xl p-4 border border-blue-200/50 shadow-sm">
        ...
        <nav className="space-y-3">
          ...
          >
            ...
            >
              <svg
                className={`w-4 h-4 ${
                  activeTab === "create" ? "text-white" : "text-blue-600"
                }`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
            ...
            <div>
              ...
              <div
                className={`text-xs ${
                  activeTab === "create" ? "text-blue-100" : "text-gray-500"
                }`}
              >
          ...
          >
            ...
            >
              <svg
                className={`w-4 h-4 ${
                  activeTab === "manage" ? "text-white" : "text-purple-600"
                }`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
            ...
            <div>
              ...
              <div
                className={`text-xs ${
                  activeTab === "manage" ? "text-blue-100" : "text-gray-500"
                }`}
              >

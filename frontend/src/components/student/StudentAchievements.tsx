  ...
  return (
    <div className="bg-gradient-to-br from-card to-card/50 rounded-2xl border border-border/50 p-6">
      <div className="text-center mb-6">
        <h3 className="text-xl font-bold text-foreground mb-2">Medal Achievements</h3>
        <div className="w-12 h-0.5 bg-primary mx-auto rounded-full"></div>
      </div>
      
      <div className="grid grid-cols-3 gap-4">
        <div className="text-center p-4 bg-gradient-to-br from-yellow-500/10 to-yellow-500/5 rounded-xl border border-yellow-500/20 transition-all duration-300">
        ...
        <div className="text-center p-4 bg-gradient-to-br from-gray-500/10 to-gray-500/5 rounded-xl border border-gray-500/20 transition-all duration-300">
        ...
        <div className="text-center p-4 bg-gradient-to-br from-amber-600/10 to-amber-600/5 rounded-xl border border-amber-600/20 transition-all duration-300">
          ...
          <div className="text-xs text-gray-500 font-medium">Bronze</div>
        </div>
      </div>
    </div>
  );

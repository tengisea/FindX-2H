...
import { X, Calendar, Users, Trophy, Target, Clock, Star } from 'lucide-react'
...
const CreateTournamentModal: React.FC<CreateTournamentModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 backdrop-blur-md flex items-center justify-center z-50 p-4">
            <Card className="w-full max-w-2xl max-h-[90vh] overflow-y-auto bg-white bg-opacity-95 shadow-2xl border border-gray-200">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6 ">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => handleInputChange('piPoints', parseInt(e.target.value) || 0)}
                                        placeholder="e.g., 50"
                                        className={errors.piPoints ? 'border-red-500' : ''}
                                    />
                                    {errors.piPoints && <p className="text-sm text-red-500">{errors.piPoints}</p>}
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                >
                                    <option value={Status.Opening}>Opening (Registration Open)</option>
                                    <option value={Status.Ongoing}>Ongoing (Tournament Active)</option>
                                    <option value={Status.Finished}>Finished (Tournament Complete)</option>
                                </select>
                            </div>
                        </div>
                        ...
                        {error && (
                            <div className="bg-red-50 border border-red-200 rounded-md p-4">
                                <p className="text-red-800 font-medium">Error creating tournament:</p>

...
const UpdateTournamentStatusModal: React.FC<UpdateTournamentStatusModalProps> = ({
    isOpen,
    onClose,
    onSuccess,
    tournamentId,
    ...
    const [updateTournamentStatus, { loading, error }] = useUpdateTournamentStatusMutation()
    ...
    return (
        <div className="fixed inset-0 backdrop-blur-md flex items-center justify-center z-50 p-4">
            <Card className="w-full max-w-md bg-white bg-opacity-95 shadow-2xl border border-gray-200">
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
                    <div>
                        ...
                        <CardDescription>
                            Change the status of "{tournamentName}"
                        </CardDescription>
                    </div>
                ...
                <CardContent>
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className={`px-3 py-2 rounded-md border ${getStatusColor(currentStatus as Status)}`}>
                        ...
                        <div className="bg-yellow-50 border border-yellow-200 rounded-md p-3">
                            <div className="flex items-center gap-2 text-yellow-800">
                                ...
                                <span className="text-sm font-medium">
                                    Changing tournament status will affect participant access and tournament flow.
                                </span>
                            </div>
                        </div>

...
export default function Stepper({
  ...
  return (
    <div
      className="flex min-h-full flex-1 flex-col items-center mt-5 justify-center sm:aspect-[4/3] md:aspect-[2/1]"
      {...rest}
    >
      <div
        className={`w-full bg-white rounded-4xl border border-gray-200 ${stepCircleContainerClassName}`}
      >
        <div
...
function StepIndicator({
  ...
  return (
    ...
    >
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: "#FF8400", color: "#FF8400" },
...
function StepConnector({ isComplete }: StepConnectorProps) {
  const lineVariants: Variants = {
    ...
    complete: { width: "100%", backgroundColor: "#FF8400ty" },
  };
